...
func (_StandardBridge *StandardBridgeTransactor) BridgeETH(opts *bind.TransactOpts, _amount *big.Int, _minGasLimit uint32, _extraData []byte) (*types.Transaction, error) {
	return _StandardBridge.contract.Transact(opts, "bridgeETH", _amount, _minGasLimit, _extraData)
}

// BridgeETH is a paid mutator transaction binding the contract method 0x162f1686.
//
// Solidity: function bridgeETH(uint256 _amount, uint32 _minGasLimit, bytes _extraData) payable returns()
func (_StandardBridge *StandardBridgeSession) BridgeETH(_amount *big.Int, _minGasLimit uint32, _extraData []byte) (*types.Transaction, error) {
	return _StandardBridge.Contract.BridgeETH(&_StandardBridge.TransactOpts, _amount, _minGasLimit, _extraData)
}

// BridgeETH is a paid mutator transaction binding the contract method 0x162f1686.
//
// Solidity: function bridgeETH(uint256 _amount, uint32 _minGasLimit, bytes _extraData) payable returns()
func (_StandardBridge *StandardBridgeTransactorSession) BridgeETH(_amount *big.Int, _minGasLimit uint32, _extraData []byte) (*types.Transaction, error) {
	return _StandardBridge.Contract.BridgeETH(&_StandardBridge.TransactOpts, _amount, _minGasLimit, _extraData)
}
...
func (_StandardBridge *StandardBridgeTransactor) BridgeETHTo(opts *bind.TransactOpts, _to common.Address, _amount *big.Int, _minGasLimit uint32, _extraData []byte) (*types.Transaction, error) {
	return _StandardBridge.contract.Transact(opts, "bridgeETHTo", _to, _amount, _minGasLimit, _extraData)
}

// BridgeETHTo is a paid mutator transaction binding the contract method 0xc3a1763c.
//
// Solidity: function bridgeETHTo(address _to, uint256 _amount, uint32 _minGasLimit, bytes _extraData) payable returns()
func (_StandardBridge *StandardBridgeSession) BridgeETHTo(_to common.Address, _amount *big.Int, _minGasLimit uint32, _extraData []byte) (*types.Transaction, error) {
	return _StandardBridge.Contract.BridgeETHTo(&_StandardBridge.TransactOpts, _to, _amount, _minGasLimit, _extraData)
}

// BridgeETHTo is a paid mutator transaction binding the contract method 0xc3a1763c.
//
// Solidity: function bridgeETHTo(address _to, uint256 _amount, uint32 _minGasLimit, bytes _extraData) payable returns()
func (_StandardBridge *StandardBridgeTransactorSession) BridgeETHTo(_to common.Address, _amount *big.Int, _minGasLimit uint32, _extraData []byte) (*types.Transaction, error) {
	return _StandardBridge.Contract.BridgeETHTo(&_StandardBridge.TransactOpts, _to, _amount, _minGasLimit, _extraData)
}
