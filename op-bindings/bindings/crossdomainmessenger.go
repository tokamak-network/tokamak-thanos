...
func (_CrossDomainMessenger *CrossDomainMessengerTransactor) SendDepositTONMessage(opts *bind.TransactOpts, _target common.Address, _amount *big.Int, _message []byte, _minGasLimit uint32) (*types.Transaction, error) {
	return _CrossDomainMessenger.contract.Transact(opts, "sendDepositTONMessage", _target, _amount, _message, _minGasLimit)
}

// SendDepositTONMessage is a paid mutator transaction binding the contract method 0x921d4435.
//
// Solidity: function sendDepositTONMessage(address _target, uint256 _amount, bytes _message, uint32 _minGasLimit) returns()
func (_CrossDomainMessenger *CrossDomainMessengerSession) SendDepositTONMessage(_target common.Address, _amount *big.Int, _message []byte, _minGasLimit uint32) (*types.Transaction, error) {
	return _CrossDomainMessenger.Contract.SendDepositTONMessage(&_CrossDomainMessenger.TransactOpts, _target, _amount, _message, _minGasLimit)
}

// SendDepositTONMessage is a paid mutator transaction binding the contract method 0x921d4435.
//
// Solidity: function sendDepositTONMessage(address _target, uint256 _amount, bytes _message, uint32 _minGasLimit) returns()
func (_CrossDomainMessenger *CrossDomainMessengerTransactorSession) SendDepositTONMessage(_target common.Address, _amount *big.Int, _message []byte, _minGasLimit uint32) (*types.Transaction, error) {
	return _CrossDomainMessenger.Contract.SendDepositTONMessage(&_CrossDomainMessenger.TransactOpts, _target, _amount, _message, _minGasLimit)
}
