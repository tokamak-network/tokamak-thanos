...
func (_CrossDomainMessenger *CrossDomainMessengerTransactor) SendTONMessage(opts *bind.TransactOpts, _target common.Address, _amount *big.Int, _message []byte, _minGasLimit uint32) (*types.Transaction, error) {
	return _CrossDomainMessenger.contract.Transact(opts, "sendTONMessage", _target, _amount, _message, _minGasLimit)
}

// SendTONMessage is a paid mutator transaction binding the contract method 0xcb8398bf.
//
// Solidity: function sendTONMessage(address _target, uint256 _amount, bytes _message, uint32 _minGasLimit) returns()
func (_CrossDomainMessenger *CrossDomainMessengerSession) SendTONMessage(_target common.Address, _amount *big.Int, _message []byte, _minGasLimit uint32) (*types.Transaction, error) {
	return _CrossDomainMessenger.Contract.SendTONMessage(&_CrossDomainMessenger.TransactOpts, _target, _amount, _message, _minGasLimit)
}

// SendTONMessage is a paid mutator transaction binding the contract method 0xcb8398bf.
//
// Solidity: function sendTONMessage(address _target, uint256 _amount, bytes _message, uint32 _minGasLimit) returns()
func (_CrossDomainMessenger *CrossDomainMessengerTransactorSession) SendTONMessage(_target common.Address, _amount *big.Int, _message []byte, _minGasLimit uint32) (*types.Transaction, error) {
	return _CrossDomainMessenger.Contract.SendTONMessage(&_CrossDomainMessenger.TransactOpts, _target, _amount, _message, _minGasLimit)
}
