...
func (_CrossDomainMessenger *CrossDomainMessengerCaller) RELAYGASCHECKBUFFERINCLUDINGAPPROVAL(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _CrossDomainMessenger.contract.Call(opts, &out, "RELAY_GAS_CHECK_BUFFER_INCLUDING_APPROVAL")
...
//
// Solidity: function RELAY_GAS_CHECK_BUFFER_INCLUDING_APPROVAL() view returns(uint64)
func (_CrossDomainMessenger *CrossDomainMessengerSession) RELAYGASCHECKBUFFERINCLUDINGAPPROVAL() (uint64, error) {
	return _CrossDomainMessenger.Contract.RELAYGASCHECKBUFFERINCLUDINGAPPROVAL(&_CrossDomainMessenger.CallOpts)
}

// RELAYGASCHECKBUFFERINCLUDINGAPPROVAL is a free data retrieval call binding the contract method 0x7f87f520.
//
// Solidity: function RELAY_GAS_CHECK_BUFFER_INCLUDING_APPROVAL() view returns(uint64)
func (_CrossDomainMessenger *CrossDomainMessengerCallerSession) RELAYGASCHECKBUFFERINCLUDINGAPPROVAL() (uint64, error) {
	return _CrossDomainMessenger.Contract.RELAYGASCHECKBUFFERINCLUDINGAPPROVAL(&_CrossDomainMessenger.CallOpts)
}
