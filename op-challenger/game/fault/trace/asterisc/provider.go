...
// FindStep is deprecated and removed in the latest Optimism version
// func (p *AsteriscTraceProviderForTest) FindStep(ctx context.Context, start uint64, preimage utils.PreimageOpt) (uint64, error) {
// 	// This functionality has been moved to vm.Executor
// 	return 0, fmt.Errorf("FindStep is deprecated")
// }
