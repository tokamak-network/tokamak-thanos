 ...
 * @notice Script to verify and register L1 contracts
 * @dev This script sets verification possible through multisig and then verifies/registers contracts directly
 */
contract VerifyContractSetConfig is Script {
    // Environment variables
    address private _l1ContractVerificationProxy;
    ...
    function setUp() public {
        ...
        _l1ContractVerificationProxy = vm.envAddress('L1_CONTRACT_VERIFICATION_PROXY');
    ...
    function run() external {
        ...
        // Get the L1ContractVerification contract
        L1ContractVerification verifier = L1ContractVerification(_l1ContractVerificationProxy);


        bool success = verifier.verifyAndRegisterRollupConfig(
            _systemConfigProxy,
            _l1ProxyAdmin,
            2, // TON token type
        ...
        require(success, "Verification and registration failed");
        vm.stopBroadcast();

        // console.log("Contracts verified and registered successfully");
    }
}
