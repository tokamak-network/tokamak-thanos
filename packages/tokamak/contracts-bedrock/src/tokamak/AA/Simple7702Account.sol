...
// License: GPL-3.0
// Thanos modifications: hardcoded EntryPoint address updated to Thanos predeploy (0x4200...0063).
...
contract Simple7702Account is BaseAccount, IERC165, IERC1271, ERC1155Holder, ERC721Holder {
    ...
    // address of Thanos predeploy EntryPoint v0.8
    function entryPoint() public pure override returns (IEntryPoint) {
        return IEntryPoint(0x4200000000000000000000000000000000000063);
    }
    ...
    function supportsInterface(bytes4 id) public override(ERC1155Receiver, IERC165) view returns (bool) {
        return
