...
// License: GPL-3.0
// Thanos modifications: import path updates, "ETH" → "native token (TON)" in comments.
 ...
 * Deposit is just a balance used to pay for UserOperations via native token (TON) (either by a paymaster or an account).
