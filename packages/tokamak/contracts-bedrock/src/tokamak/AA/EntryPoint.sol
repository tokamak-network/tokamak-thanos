...
import "./lib/StakeManager.sol";
import "./lib/NonceManager.sol";
import "./lib/Helpers.sol";
import "./lib/SenderCreator.sol";
import "./lib/Eip7702Support.sol";
import "./utils/Exec.sol";

import "@openzeppelin/contracts_v5.0.1/utils/ReentrancyGuard.sol";
import "@openzeppelin/contracts_v5.0.1/utils/introspection/ERC165.sol";
import "@openzeppelin/contracts_v5.0.1/utils/cryptography/EIP712.sol";
...
contract EntryPoint is IEntryPoint, StakeManager, NonceManager, ReentrancyGuard, ERC165, EIP712 {
     ...
     * @return actualGasCost - the actual cost in native token (TON) this UserOperation paid for gas
     */
