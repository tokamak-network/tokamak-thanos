...
library Predeploys {
    ...
    /// @notice Address of the Commit2RevealDRB predeploy (Gaming/Full presets only).
    address internal constant COMMIT2REVEAL_DRB = 0x4200000000000000000000000000000000000060;
    ...
    function getName(address _addr) internal pure returns (string memory out_) {
        ...
        if (_addr == LEGACY_ERC20_NATIVE_TOKEN) return "LegacyERC20NativeToken";
