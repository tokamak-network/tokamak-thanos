...
const depositNativeToken = async (amount: NumberLike) => {
  ...
  let standardStorage = await L1StandardBridgeContract.deposits(l2NativeToken,predeploys.LegacyERC20NativeToken)
  ...
  standardStorage = await L1StandardBridgeContract.deposits(l2NativeToken,predeploys.LegacyERC20NativeToken)
  console.log('standardStorage: ', standardStorage.toString())
}
