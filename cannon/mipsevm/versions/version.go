...
const (
	// VersionSingleThreaded is the version of the Cannon STF found in op-contracts/v1.6.0 - https://github.com/tokamak-network/tokamak-thanos/blob/op-contracts/v1.6.0/packages/tokamak/contracts-bedrock/src/cannon/MIPS.sol
