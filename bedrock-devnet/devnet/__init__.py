...
parser.add_argument('--native', help='Native Token enable', type=bool, action=argparse.BooleanOptionalAction)
...
def main():
    ...
    contracts_bedrock_dir = pjoin(monorepo_dir, 'packages', 'tokamak', 'contracts-bedrock') if args.native else pjoin(monorepo_dir, 'packages', 'contracts-bedrock')
    ...
    sdk_dir = pjoin(monorepo_dir, 'packages', 'tokamak', 'sdk') if args.native == True else pjoin(monorepo_dir, 'packages', 'sdk')
